...
<body>
	...
	<?php
		...
		if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $arr1 = array('First name' =>$firstName, 'Last name'=> $lastName, 'Gender'=> $gender,'DoB(date and time)'=> $dob,'Religion'=> $religion,'Present Address'=> $preaddress, 'Permanent Address'=> $paraddress, 'Phone number'=> $phone,'Personal website link'=> $pweblink, 'Email'=> $email, 'Username'=> $username, 'Password'=>$password ); 
